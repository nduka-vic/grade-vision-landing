...
import { Target, Calculator, TrendingUp, Eye, BookOpen, Award } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Transform your academic journey with tools designed for Nigerian university students.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-2xl p-8 border border-gray-700">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">Built for Nigerian Universities</h3>
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  <Eye className="w-5 h-5 text-pink-400" />
                  <span className="text-gray-300">4.0 and 5.0 grading systems supported</span>
                </li>
                <li className="flex items-center space-x-3">
                  <BookOpen className="w-5 h-5 text-pink-400" />
                  <span className="text-gray-300">Course unit calculations</span>
                </li>
                <li className="flex items-center space-x-3">
                  <Award className="w-5 h-5 text-pink-400" />
                  <span className="text-gray-300">Class of degree predictions</span>
                </li>
              </ul>
            </div>
            <div className="bg-gray-800 rounded-lg p-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-pink-400 mb-2">4.2</div>
