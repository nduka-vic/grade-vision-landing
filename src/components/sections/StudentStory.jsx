        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
            ...
            <p>
              ...
              she stood academically. Her CGPA calculations were guesswork, and
              she couldn't tell if she was on track for her goals.
            </p>
            <p className="text-pink-400 font-semibold">
              That's when she discovered Grade Vision — and everything changed.
            </p>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-pink-500/30 to-purple-500/30 rounded-2xl p-8 backdrop-blur-sm border border-gray-700">
            <div className="space-y-4">
              ...
              <p className="text-gray-300 italic">
                "Grade Vision helped me visualize my path to first-class. I went
                from guessing to knowing exactly what grades I needed each
                semester."
              </p>
